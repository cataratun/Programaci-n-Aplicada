...
#Imprime en el rango de 0 a 2 (sin incluir el 2)
print(my_lista[0:2])
print(my_lista[:2])
...
#Agrega el elemento en la posición 3
...
#Imprime la posición del elemento
...
#Agrega el elemento en la posición 8
my_lista.insert(8, 'Marron')
print(my_lista)

#Imprime el elemento en la última posición
print(my_lista.pop())
size = len(my_lista)
print("size = ", size)
#print(my_lista.pop(size))

#Multiplica la lista por 3
